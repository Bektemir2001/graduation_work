    ...
    const msgHTML = `
        <div class="msg ${side}-msg">
          ...
          <div class="msg-bubble">
            ...
            <div class="msg-text" id="message_id${message_id}">${text}</div>
          </div>
        </div>
      `;
    message_id += 1;
...
function appendMessageBot(name, img, side, text) {
    ...
    <div class="msg ${side}-msg">
      ...
      <div class="msg-bubble">
        ...
        <div class="msg-text" id="message_id${message_id}">
  ...
  `;
    ...
    msgerChat.insertAdjacentHTML("beforeend", msgHTML);
    msgerChat.scrollTop += 500;
    let url = 'http://192.168.201.186:8990/api/chat';
    let data = new FormData();
    data.append('text', clientMessage);
    fetch(url, {
        method: 'POST',
        body: data
    })
        ...
        .then(data => {
            document.getElementById(`message_id${current_message_id}`).innerHTML = data.answer;
        });
}
function botResponse() {
  appendMessageBot(BOT_NAME, BOT_IMG, "left", "...");
}
